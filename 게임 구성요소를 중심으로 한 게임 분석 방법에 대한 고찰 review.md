...
## 연구 내용
- 선행 연구의 비교 및 한계
  - 앞선 6개의 게임 분석 방법을 표로 나타내면 <br>
  |**선행 연구**|**추상적/구체적**|**구성요소를 추출의 기준**|**구성요소의 실용성**|**분석의 틀**|**분석의 표**|**접근성**|<br>
  |:---:|:---:|:---:|:---:|:---:|:---:|:---:|<br>
  |Jesse Schell|S|X|X|X|X|X|<br>
  |MDA|A|X|X|O|X|O|<br>
  |HCI|A|O|X|X|X|X|<br>
  |Design Pattern|A|O|X|X|X|X|<br>
  |Paolo Taje|S|X|O|O|X|X|<br>
  |Report of KOCCA|S|O|O|O|X|X|<br>
